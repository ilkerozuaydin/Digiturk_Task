    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = "Digiturk Article Api",
                    Description = "Digiturk Article Api",
                    Contact = new OpenApiContact() { Name = "Destek", Email = "ilkerozuaydin@hotmail.com", Url = new Uri("http://digiturkarticle.com.tr") }
                });
